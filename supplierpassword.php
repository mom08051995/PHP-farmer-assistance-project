   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $sql = "SELECT * FROM suppliers WHERE name = '$username' and aadhar = '$aadhar'" ;
...
$msg = "Your Password:".$row['password'];
     ...
     echo "alert('$msg');";
     echo "</script>";    
         header("Refresh:1;url=supplierpassword.php");
  
   }
      else  
      {
         echo "Your Login Username or aadharnumber is invalid";
		 header("Refresh:2;url=supplierpassword.php");
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Supplier Password Recovery</li>
     </ul>
   </div>
   <div class="services">
