   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $sql = "SELECT * FROM suppliers WHERE name = '$username' and password = '$password'" ;
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Supplier Login</li>
     </ul>
   </div>
   <div class="services">
    ...
    <h3> <a href="supplierpassword.php">Forgot Password?</a></h3>
  </div>
	   </form>
	  </div>
	  <div class="col-sm-6">
