   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $sql = "SELECT * FROM farmers WHERE username = '$username' and password = '$password'" ;
      ...
      else  
      {
		 ...
		 header("Refresh:2;url=farmerlogin.php");
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Farmer Login</li>
     </ul>
   </div>
   <div class="services">
    ...
    <h3> <a href="farmerpassword.php">Forgot Password?</a></h3>
  </div>
