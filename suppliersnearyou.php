...
<section id="intro" class="intro">
		<div class="container ">
			<div class="col-lg-12">
				<br><br>
				<h1 class="text-warning text-center"> Farmer :<?php echo $username ?>.DETAILS OF SUPPLIES NEAR</h1>	
				 <br>
    ...
    <tbody>
          <?php
            ...
            $conn = mysqli_connect("localhost","root","","farm");
             $result=mysqli_query($conn,"SELECT * FROM suppliers WHERE state= '$state'");
