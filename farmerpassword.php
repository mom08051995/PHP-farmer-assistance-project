   ...
   if($_SERVER["REQUEST_METHOD"] == "POST")
    {
      ...
      $sql = "SELECT * FROM farmers WHERE username = '$username' and aadhar = '$aadhar'" ;
...
$msg = "Your Password:".$row['password'];
     ...
     echo "alert('$msg');";
     echo "</script>";    
         header("Refresh:1;url=farmerpassword.php");
  
   }
      else  
      {
         echo "Your Login Username or aadharnumber is invalid";
		 header("Refresh:2;url=farmerpassword.php");
  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Farmer Password Recovery</li>
     </ul>
   </div>
   <div class="services">
	   ...
	   <form method="POST">
	    ...
	    <div class="form-item form-type-password form-item-pass">
	      <label for="edit-pass">Aadhar Number <span class="form-required" title="This field is required.">*</span></label>
	      <input type="text" id="edit-pass" name="aadhar" size="60" maxlength="128" class="form-text required">
	    </div>
